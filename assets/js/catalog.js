...
const PRESETS = {
  'nurseryprimary': {
    ...
    modules: ['students','staff','classes','subjects','attendance','cbt-prompts','entrance','results','certificates','flyer','cbt','report-cards','analytics','admin-data','academic_records','storage','approvals','timetable-generator','checkin','diary','surveys','menu','settings','fees','messages','parents','gallery','birthdays','idcards','directory','developer'],
  ...
  'tutorial': {
    ...
    modules: ['students','staff','attendance','results','idcards','certificates','flyer','cbt','report-cards','analytics','admin-data','academic_records','storage','approvals','timetable-generator','checkin','diary','surveys','menu','settings','fees','messages','gallery','eresources','directory','broadcast','voting','developer'],
    levels:['JAMB Prep','WAEC Prep','GCE Prep','SAT Prep','IELTS Prep','A-Level Prep']
  },
  'tertiary': {
    name:'College / Tertiary', emoji:'🎓',
    modules: ['students','staff','classes','subjects','attendance','cbt-prompts','entrance','results','idcards','certificates','flyer','report-cards','analytics','admin-data','academic_records','storage','approvals','timetable-generator','checkin','diary','surveys','menu','settings','fees','cbt','library','digital_library','eresources','announcements','events','gallery','directory','broadcast','hostel','voting','developer'],
