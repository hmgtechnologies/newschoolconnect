  ...
  dashboard(config) {
    return T.shell(config, 'Dashboard', `
      <div class="card" style="margin-bottom:18px;background:var(--gradient);color:#fff">
        ...
        <p style="margin:4px 0 0;opacity:.9">Role: <strong id="dash-user-role">—</strong> · This dashboard adapts to your permission level.</p>
      </div>
      <div id="dash-role-panels">
        <section data-dash-role="super_admin admin principal proprietor head_teacher bursar" style="display:none">
          ...
          <div class="grid grid-2">
            ...
            <div class="card"><h3>✅ Admin Actions</h3><div style="display:flex;gap:8px;flex-wrap:wrap"><a class="btn btn-primary" href="approvals.html">Approve users</a><a class="btn btn-outline" href="admin-data.html">Backup/Restore</a><a class="btn btn-outline" href="storage.html">Storage</a><a class="btn btn-outline" href="analytics.html">Analytics</a></div></div>
          </div>
        </section>
        <section data-dash-role="staff teacher" style="display:none">
          <div class="stats-grid"><div class="stat-card"><div class="stat-value" id="stat-my-classes">—</div><div class="stat-label">Classes</div></div><div class="stat-card"><div class="stat-value" id="stat-open-cbt">—</div><div class="stat-label">Open CBT</div></div><div class="stat-card"><div class="stat-value" id="stat-attendance-today">—</div><div class="stat-label">Attendance Today</div></div></div>
          <div class="card"><h3>👨‍🏫 Staff Workspace</h3><div style="display:flex;gap:8px;flex-wrap:wrap"><a class="btn btn-primary" href="attendance.html">Take Attendance</a><a class="btn btn-outline" href="results.html">Enter Results</a><a class="btn btn-outline" href="cbt.html">CBT Exams</a><a class="btn btn-outline" href="sow.html">Scheme</a><a class="btn btn-outline" href="assignments.html">Assignments</a></div></div>
        </section>
        <section data-dash-role="parent" style="display:none">
          <div class="card"><h3>👨‍👩‍👧 Parent Portal</h3><p>View your linked children only: attendance, fees, results, assignments and announcements.</p><div style="display:flex;gap:8px;flex-wrap:wrap"><a class="btn btn-primary" href="student-profile.html">My Child Dashboard</a><a class="btn btn-outline" href="fees.html">Fees</a><a class="btn btn-outline" href="results.html">Results</a><a class="btn btn-outline" href="complaints.html">Submit Complaint</a></div></div>
        </section>
        <section data-dash-role="student" style="display:none">
          <div class="card"><h3>🎓 Student Portal</h3><p>Access assignments, CBT exams, timetable, results, learning resources and your record card.</p><div style="display:flex;gap:8px;flex-wrap:wrap"><a class="btn btn-primary" href="cbt-exam.html">Take CBT</a><a class="btn btn-outline" href="assignments.html">Assignments</a><a class="btn btn-outline" href="eresources.html">E-Resources</a><a class="btn btn-outline" href="student-profile.html">My Record</a></div></div>
        </section>
      </div>
      <div class="grid grid-2">
        ...
        <div class="card"><h3>📌 Quick Links</h3><div id="dash-quick-links" style="display:flex;gap:8px;flex-wrap:wrap;margin-top:10px"></div></div>
      </div>`);
  },
